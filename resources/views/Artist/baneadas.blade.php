...
@section('content')
    ...
    <div class=" mt-4 mb-3 d-flex align-items-center">
        ...
        <h2 style="display: inline-block">Fotos de {{Auth::user()->nombre}} Baneadas</h2>
...
<div class="galeria" >
    @foreach($imagenes as $id => $imagen)
        @if(auth()->check() && auth()->user()->user == $imagen->cuenta_user && $imagen->baneada != 0)
                    ...
                    <div class="col text-end pt-2">
                            ...
                            <div class="dropdown">
                                ...
                                @if (auth()->check() && auth()->user()->perfil_id == 1)
                                        <li><a class="dropdown-item" href="#">Banear</a></li>
                                @endif
