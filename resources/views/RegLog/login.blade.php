                ...
                <div class="card bg-darkBG text-white shadow">
                    ...
                    <div class="card-body bg-navbarBG">
                        ...
                        @csrf
                            ...
                            <div class="mt-4 mb-1">
                                <button type="submit" class="btn btn-primary" id="boton"><b>Iniciar Sesión</b></button>
                                <a href="{{route('Home.home')}}" class="btn btn-gray text-white">Cancelar</a>
                            </div>
                        </form>
                        <a href="{{route('RegLog.register')}}" ><small>¿aún no tienes una cuenta? Registrate</small></a>
                    </div>
                </div>
            </div>
        </div>
